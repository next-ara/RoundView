...
public class RoundListView extends ListView {
    ...
    public RoundListView(@NonNull Context context) {
        super(context);
    }

    public RoundListView(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        //初始化
        this.init(context, attrs);
    }

    public RoundListView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
