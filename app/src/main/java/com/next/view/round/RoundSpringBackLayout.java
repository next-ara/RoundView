...
import com.next.view.springback.SpringBackLayout;
 ...
 * @auditor
 */
public class RoundSpringBackLayout extends SpringBackLayout {
    ...
    public RoundSpringBackLayout(@NonNull Context context) {
        super(context);
        //初始化
        this.init(context, null);
    }

    public RoundSpringBackLayout(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        //初始化
